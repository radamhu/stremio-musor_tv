...
class TestMidnightBoundary(unittest.TestCase):
    """Test cases for infer_start_iso with midnight boundary scenarios."""
    ...
    def test_full_datetime_with_extra_text(self):
        ...
        result = infer_start_iso("Start: 2025.10.18 22:30 - Some Movie")
        expected = datetime(2025, 10, 18, 22, 30).isoformat()
        self.assertEqual(result, expected)

    @patch('musor_parser.datetime')
    ...
    def test_no_time_pattern_fallback(self):
        ...
        result = infer_start_iso("No time here!")
...
class TestTimeParsingEdgeCases(unittest.TestCase):
    ...
    def test_single_digit_hour(self):
        ...
        result = infer_start_iso("2025.10.18 9:30")
